...
> **A constraint the brief's setup creates.** Gamma with a log link requires
...
(`seed=42`): Linear Regression (ElasticNet), GLM (Gamma/log), LinearSVC, Random
...
./submit_pipeline.sh                            # tournament + MLflow
